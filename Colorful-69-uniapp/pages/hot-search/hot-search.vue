		...
		<view class="search-container">
			<view class="search-box u-flex u-flex-between p-30">
				<view class="search-input-container">
					<input v-model="searchKeyword" placeholder="搜索视频..." class="search-input" @input="onSearchInput"
				...
				<view class="video-list">
					<view v-for="video in videoList" :key="video.id" class="video-item" @click="goToVideoDetail(video)">
						<view class="video-cover">
							...
							<image class="hot-tag" v-if="video.vod_hot === 1" src="/static/home/ic_video_hot.png"
						...
						<view class="video-info">
							<view class="video-stats">
								...
								<view class="stats-right">
									<image class="icon-30" src="/static/home/ic_video_look.png" mode="aspectFit">
									</image>
